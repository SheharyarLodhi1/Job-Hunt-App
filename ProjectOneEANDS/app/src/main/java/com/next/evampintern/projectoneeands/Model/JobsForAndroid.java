...
public class JobsForAndroid {
    ...
    public JobsForAndroid(String type, String jobUrl, String createdDate, String companyName, String companyUrl, String location,
                          String jobTitle, String jobDescription, String companyLogo){
        mJobType = type;
        mJobUrl = jobUrl;
